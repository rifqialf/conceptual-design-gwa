# Introduction
This repository is part of MSc Thesis titled "A Model-Driven Approach for Developing REST-Based Geospatial Web Application Using UML Profiles" by Rifqi Alfadhillah Sentosa, defended at ITC University of Twente in July 2024. Full thesis can be accessed [here](https://essay.utwente.nl/102059/).
...
## PIM Profiles
In directory `/mda-demo/mda/pim-profiles` the UML profiles for PIM development can be found and used by users.
...
## PSM Profiles
In directory `/mda-demo/mda/psm-profiles` the UML profiles for PSM development can be found.
